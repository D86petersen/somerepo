        ...
        <div className="mx-auto flex w-full max-w-md flex-col items-center">
          ...
          <div className="w-full space-y-4">
            <label className="flex w-full flex-col min-w-40 flex-1">
              <p className="text-white text-base font-medium leading-normal pb-2">Email / Username</p>
              <input
            ...
            <p className="text-slate-400 text-sm font-normal leading-normal text-right underline hover:text-white transition-colors cursor-pointer">Forgot Password?</p>
          </div>
          <div className="w-full mt-8 space-y-4">
            ...
            <p className="text-center text-slate-300">Don&apos;t have an account? <a className="font-semibold text-white underline hover:text-primary/90 transition-colors" href="/signup">Sign Up</a></p>
          </div>
